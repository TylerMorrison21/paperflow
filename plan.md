...
- [x] P0 Market-ready base (Checklist):
  - [x] Analytics: PostHog event tracking (visit_home / upload_start / parse_success / parse_failed / reader_view / share_copy_link / feedback_submit / export_markdown / inline_popover / text_highlight / export_highlights / copy_with_citation)
  ...
  - [x] Copy with citation: Auto-append attribution to clipboard for viral PLG growth (GENIUS GROWTH HACK)
...
- Key features completed:
  ...
  - Copy with citation (viral PLG growth - auto-appends attribution to clipboard)
